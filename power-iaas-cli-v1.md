...
# IBM {{site.data.keyword.powerSys_notm}} CLI Reference V 1.3.0
...
```bash
  -o, --operation string   Operation to be done in a workspace. Valid values are per-migrate-start, per-migrate-status, per-migrate-validate.
```
